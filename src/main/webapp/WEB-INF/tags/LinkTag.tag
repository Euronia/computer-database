...
<c:if test="$(pageComputer.currentPage > pageComputer.nbPages)">
        ...
        <div class="btn-group btn-group-sm pull-right" role="group" >
            <button type="button" class="btn btn-default" onclick="location.href='?page=1&perPage=10&search=${filter}'">10</button>
            <button type="button" class="btn btn-default" onclick="location.href='?page=1&perPage=50&search=${filter}'">50</button>
            <button type="button" class="btn btn-default" onclick="location.href='?page=1&perPage=100&search=${filter}'">100</button>
        </div>
        </div>
